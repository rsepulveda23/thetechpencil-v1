  ...
  return (
    <div className="space-y-8">
      <div className="prose dark:prose-invert">
        <h1 className="font-serif">Join The Tech Pencil</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg border p-6 bg-card">
          ...
          <a href="/login" className="px-4 py-2 rounded border inline-block">Join free</a>
        </div>
        <div className="rounded-lg border p-6 bg-card ring-1 ring-foreground/10">
          <h3 className="font-semibold">Member</h3>
          <p className="text-sm text-muted-foreground mb-4">Get full Signals, most Research, downloads, and Ask Tech Pencil. Two‑minute sign‑up. Cancel anytime.</p>
        ...
        <div className="rounded-lg border p-6 bg-card">
          ...
          <a href="/checkout/success?demo=1&type=subscription-annual" className="px-4 py-2 rounded bg-foreground text-background inline-block">Upgrade to Membership</a>
        </div>
      </div>
