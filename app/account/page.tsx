  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded border p-4">
        ...
        {process.env.DEMO_MODE === 'true' ? (
          <a href="/checkout/success?demo=1&type=portal" className="px-3 py-1.5 rounded bg-foreground text-background inline-block">Manage billing</a>
        ) : (
          <form action="/api/stripe/portal" method="post">
            <button className="px-3 py-1.5 rounded bg-foreground text-background">Manage billing</button>
          </form>
        )}
